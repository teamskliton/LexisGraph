...
def _build_legal_assistant_prompt(
    ...
    return (
        ...
        "4. AT THE VERY END OF YOUR RESPONSE, output a JSON recommendations block starting exactly with '--- RECOMMENDATIONS_JSON ---' containing 3 short follow-up questions and recommended actions.\n\n"
