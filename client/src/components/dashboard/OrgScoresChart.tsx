          ...
          <div className="flex items-center gap-2">
            {onAddOrg && (
              <Button
                ...
                size="sm"
                onClick={onAddOrg}
                className="h-7 px-2 text-[11px] gap-1 cursor-pointer border-indigo-200 text-indigo-700 hover:bg-indigo-50 dark:border-indigo-800 dark:text-indigo-300 dark:hover:bg-indigo-950/50"
              >
        ...
        {data.length === 0 ? (
          <div className="text-center py-8 space-y-3">
            <p className="text-xs text-muted-foreground">
              No organization compliance score metrics recorded.
            </p>
            {onAddOrg && (
              <Button
                variant="outline"
